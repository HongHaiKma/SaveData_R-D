...
namespace MoreMountains.Feedbacks
{
    ...
    public abstract class MMFeedback : MonoBehaviour
    {
        ...
        public bool stopAllCoroutineBeforePlay;
        public bool stopFeedBackOnDisable;
        ...
        {
            if (stopFeedBackOnDisable)
            {
                CustomStopFeedback(Vector3.zero);
            }
        }
